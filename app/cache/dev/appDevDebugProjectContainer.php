...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'db2301.1and1.fr', 'port' => 3306, 'dbname' => 'db317049816', 'user' => 'dbo317049816', 'password' => 'Myrmica1+', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/RollRollBundle/Entity'))), 'RollRollBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('RollRollBundle' => 'RollRollBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a7cfb9d21c4ebd00f230861f5987f4aabb1f00944cec20316f168177ad75d5a7');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/RollRollBundle/Resources/views'), 'RollRoll');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56616b435d3236.22370716')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'RollRollBundle' => 'RollRollBundle\\RollRollBundle',
            ...
            'database_host' => 'db2301.1and1.fr',
            'database_port' => 3306,
            'database_name' => 'db317049816',
            'database_user' => 'dbo317049816',
            'database_password' => 'Myrmica1+',
